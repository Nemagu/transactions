...
@dataclass
class TenantAppointingTenantCommand:
    initiator_id: UUID
    tenant_id: UUID


class TenantAppointingTenantUseCase(BaseUseCase):
    async def execute(self, command: TenantAppointingTenantCommand) -> TenantSimpleDTO:
